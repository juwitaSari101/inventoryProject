...
public class Transaksi_Barangkeluar extends javax.swing.JPanel {
    ...
    private Service_Barangkeluar servis_psn = new DAO_BarangKeluar();
    private Service_Barang servis_det = new DAO_Barang();

    private TableMod_Barangkeluar tblModel_psn = new TableMod_Barangkeluar();
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Data Barang Keluar");
                ...
                .addGroup(tambahDataLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(tambahDataLayout.createSequentialGroup()
                        .addGroup(tambahDataLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(t_namaBarang, javax.swing.GroupLayout.PREFERRED_SIZE, 349, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(34, 34, 34)
    ...
    private void btn_barangmasukActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_barangmasukActionPerformed
        ...
        t_namaBarang.setText(datmas.model.getNama_barang());
    ...
    private void loadData() {
        ...
        List<Model_Barangkeluar> list = servis_psn.getData();
    ...
    private void tampilPanel() {
        mainPanel.removeAll();
        mainPanel.add(new Transaksi_Barangkeluar());
        mainPanel.repaint();
        mainPanel.revalidate();
    }
...
private void dataTabel() {
    ...
    jLabel2.setText("Perbarui Data Barang Keluar");
    ...
    t_namaBarang.setText(tbl_pesanan.getModel().getValueAt(row, 3).toString());
    ...
    private void simpanData() {
        if (validasiInput() == true) {
            try {
                ...
                String nambar = t_namaBarang.getText();
                ...
                Model_Barangkeluar model = new Model_Barangkeluar();
                model.setTgl_keluar(tgl);
                model.setJumlah_keluar(jml);
                model.setKode_barangkeluar(kodmas);
    ...
    if (index != -1) {
        Model_Barangkeluar mod = tblModel_psn.getData(tbl_pesanan.convertRowIndexToModel(index));
                ...
                Model_Barangkeluar mod_keluar = new Model_Barangkeluar();
                 mod_keluar.setTgl_keluar(tgl);
                 mod_keluar.setJumlah_keluar(jml);
                 mod_keluar.setKode_barangkeluar(kodmas);
                 
                 mod_keluar.setMod_bar(barang); 
            // Debug log
            System.out.println("Memperbarui data: " + mod.getKode_barangkeluar());

            // Update data di layanan dan tabel
            servis_psn.perbaruiData( mod_keluar); // DAO
    ...
    private void hapusData() {
        int index = tbl_pesanan.getSelectedRow();
        if (index != -1) {
            Model_Barangkeluar  brgkeluar = tblModel_psn.getData(tbl_pesanan.convertRowIndexToModel(index));
            if (JOptionPane.showConfirmDialog(null, "Yakin data akan dihapus", "Konfirmasi", JOptionPane.OK_CANCEL_OPTION) == JOptionPane.OK_OPTION) {
                servis_psn.hapusData(brgkeluar);
    ...
    private void pencarian() {
        List<Model_Barangkeluar> list = servis_psn.pencarian(t_cari.getText());
        tblModel_psn.setData(list);
    }
